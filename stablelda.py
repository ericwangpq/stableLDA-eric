...
class StableLDA():
    ...
    def init_word_cluster(self, embed_method):
        ...
        if embed_method == 'cbow':
            ...
            self.w2v_model = Word2Vec(sentences=self.text, vector_size=100, window=3, min_count=5, workers=1, epochs=10,
                                      sg=0)
        ...
        vocabs = self.w2v_model.wv.index_to_key
        ...
        self.kmeans = KMeans(n_clusters=self.num_cluster, algorithm='full', n_init=10, init='k-means++',
    ...
    def initialize(self):
      ...
      '''
        ...
        vocabs = list(self.w2v_model.wv.index_to_key)
